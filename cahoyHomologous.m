...
save('cahoy_human_homologous.mat', 'neurons_human_hsbc', 'neurons_human_entrez', 'astro_human_hsbc', 'astro_human_entrez', 'oligo_human_hsbc', 'oligo_human_entrez','fold_threshold');